...
public class AddClinicTest extends BaseControllerTest<ClinicController> {
    ...
    private String uploadBattlegroundImage(String battlegroundName, String url) throws Exception {
        ...
        return fileService.upload(uploadFileVO, super.mockRandomUser()).getFileId();
    }

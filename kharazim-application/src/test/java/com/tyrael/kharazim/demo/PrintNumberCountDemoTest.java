 ...
 * @since 2024/4/9
 */
public class PrintNumberCountDemoTest {
    ...
    public void print(List<? extends Number> numbers, Number from, Number end, Number distance) {
    ...
    private BigDecimal findClosestValue(List<BigDecimal> values, BigDecimal number) {
    ...
    private String formatNumber(Number number, int bit) {
